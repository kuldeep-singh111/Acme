...
export default function Faq() {
    ...
    const defaultContent1 = "Next.js: A React framework for building server-side rendered (SSR) React applications, offering features like file-based routing and API routes."

    const defaultContent2 =
        " React.js: A JavaScript library for building user interfaces, developed by Facebook, known for its component-based architecture and virtual DOM.";
    return (
        <section className="relative max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
            ...
            >
                ...
                >
                    ...
                    <AccordionItem key="2" aria-label="¿Why NextUI?" title="-Why Next.js?">
                        {defaultContent1}
                    </AccordionItem>
                    <AccordionItem key="3" aria-label="¿Why NextUI?" title="-Why React.js">
                        {defaultContent2}
                    </AccordionItem>
                </Accordion>
            </motion.div>
